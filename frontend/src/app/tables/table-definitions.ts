import { TableConfig } from '../core/table-config';
...
export const PARTS_CONFIG: TableConfig = {
  ...
  idField: 'part_num',
  allowCreate: false,
  displayedColumns: ['part_num', 'name', 'part_cat_id'],
  fields: [
    { key: 'part_num', label: 'Part Number', type: 'text', required: true },
...
export const SETS_CONFIG: TableConfig = {
  ...
  idField: 'set_num',
  allowCreate: false,
  displayedColumns: ['set_num', 'name', 'year', 'theme_id', 'num_parts'],
  fields: [
    { key: 'set_num', label: 'Set Number', type: 'text', required: true },
    { key: 'name', label: 'Name', type: 'text', required: true },
...
export const USER_SETS_CONFIG: TableConfig = {
  ...
  endpoint: 'user_sets',
  idField: 'user_set_id',
  displayedColumns: ['user_set_id', 'user_id', 'set_num', 'quantity', 'condition_public', 'condition_complete', 'purchase_price', 'owned_since'],
  fields: [
    {
      key: 'user_id',
      label: 'User',
